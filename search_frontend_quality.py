...
def get_results(query, body_w, title_w, anchor_w, pr_w):
...
def search():
  ...
  for query in ideal.keys():
    ...
    map10res.append(average_precision(ideal_res, res))
    recall.append(recall_at_k(ideal_res, res))
    precision.append(precision_at_k(ideal_res, res))
    rprecision.append(r_precision(ideal_res, res))
    f1.append(r_precision(ideal_res, res))
